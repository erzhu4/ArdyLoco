...
<html>
    <head>
        <title>ESP8266 DKKY Bidirectional 40A Brushed ESC</title>
    ...
    <body>
        ...
        <h1>ESP8266 DKKY Bidirectional 40A Brushed ESC</h1>
        <h4>ESP8266 Train Control. Middle of Circle is stop</h4>
        </div>
        </div>
        ...
        <script>
            ...
            document.getElementById("stopButton").addEventListener('mousedown',function(evt){
                ...
                var servoAng = 88;
                document.getElementById("driveDescription").innerHTML = "Stopped";
                document.getElementById("angle").innerHTML="Stopped";
                sendData(servoAng);
            });
            ...
            svg.addEventListener('mousedown',function(evt){
                ...
                degrees = (degrees + centerPosition)
                ...
                if (degrees<281){
                    document.getElementById("arc1").setAttribute("d", describeArc(250, 250, 200, offset, angle));
                    var servoAng = Math.round(((angle - 220)/280) * 89) * 2;

                    var displayThrottleNumber = servoAng - centerPosition;

                    if (servoAng > 84 && servoAng < 93){
                        document.getElementById("driveDescription").innerHTML = "Stopped";
                        document.getElementById("angle").innerHTML="Stopped";
                    } else {
                        document.getElementById("driveDescription").innerHTML = mainDescription;
                        document.getElementById("angle").innerHTML=displayThrottleNumber;
                    }
