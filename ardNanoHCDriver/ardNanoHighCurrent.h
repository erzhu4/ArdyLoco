...
<html>
    <head>
        <title>ARDUINO NANO HIGH CURRENT MOTOR DRIVER</title>
    ...
    <body>
        <div style="width:100%;">
            <div style="width:50%;  margin: 0 auto;">
                <h1>Arduino nano wifi with HighCurrent BTS7960 43A High Power Motor Driver</h1>
                <h4>Arduino Nano RP2040 Train Control.</h4>
            </div>
